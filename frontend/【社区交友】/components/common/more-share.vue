<template>
	<uni-popup ref="popup" type="bottom">
		<view class="text-center py-2 font-md border-bottom border-light-secondary">sharing...</view>
		...
		<view class="text-center py-2 font-md border-top border-light-secondary" hover-class="bg-light" @click="close()">cancel</view>
	</uni-popup>
</template>
